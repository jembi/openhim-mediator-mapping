  ...
  return Object.freeze({
    ...
    parser: Object.freeze({
      ...
      xmlOptions: {
        ...
        explicitRoot: parseStringToBoolean(process.env.PARSER_XML_OPTIONS_EXPLICIT_ROOT, false),
        explicitArray: parseStringToBoolean(process.env.PARSER_XML_OPTIONS_EXPLICIT_ARRAY, false)
      }
    }),
